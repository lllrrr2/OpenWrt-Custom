...
add_packages() {
    ...
    unzip luci-master.zip luci-master/applications/luci-app-n2n/* lede-master/applications/luci-app-nps/* lede-master/applications/luci-app-vsftpd/* lede-master/applications/luci-app-speederv2/*
